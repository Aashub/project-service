...
String qr="select u.name as uname,u.email as uemail,dt,bstatus from serviceprovider s,user u,booking where pemail=s.email and bstatus='Accept' and uemail=u.email and s.email=?";
