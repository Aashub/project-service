...
<li class="ttr_menu_items_parent dropdown"><a href="viewbookinguser.jsp" class="ttr_menu_items_parent_link"><span class="menuchildicon"></span>View My Bookings</a>
<hr class ="horiz_separator"/>
</li>
<li class="ttr_menu_items_parent dropdown"><a href="editUserProfile.jsp" class="ttr_menu_items_parent_link"><span class="menuchildicon"></span>Edit Profile</a>
<hr class ="horiz_separator"/>
</li>
<li class="ttr_menu_items_parent dropdown"><a href="LogoutUser" class="ttr_menu_items_parent_link"><span class="menuchildicon"></span>Logout</a>
<hr class ="horiz_separator"/>
</li>
</ul>
</div>
...
<p style="margin:0.5em 0.5em 0.5em 0.5em;text-align:Center;">&nbsp;</p><p style="margin:0.5em 0em 0.71em 0em;"><span style="font-family:'Open Sans';font-weight:700;font-size:1.429em;color:rgba(78,78,78,1);">Search a Service Provider </span></p>
<p style="text-align:Center;line-height:1.76056338028169;"><span style="font-family:'Open Sans';font-size:1em;color:rgba(78,78,78,1);"><form action="SearchProvider.jsp">
Service:<br /><select name="stype">
...
<option>Aditya nagar</option>
<option>Lig</option>
<option>Geeta bhawan</option>
<option>Bhawarkuwa</option></select><br /><br />
