...
<p style="margin:0.5em 0.5em 0.5em 0.5em;text-align:Center;">&nbsp;</p><p style="margin:0.5em 0em 0.71em 0em;"><span style="font-family:'Open Sans';font-weight:700;font-size:1.429em;color:rgba(78,78,78,1);">Edit Your Profile </span></p>
...
Service Type:<input type="text" name="stype" value=<%=stype %> /><br />
Charges:<input type="text" name="charges" value=<%=charges %> /><br />
Mobile:<input type="text" name="mob" value=<%=mob %> /><br />
Area:<input type="text" name="area" value=<%=area %> /><br />
Address:<input type="text" name="address" value=<%=address %> /><br />
Password:<input type="password" name="pwd" value=<%=pwd %> /><br /><br />
