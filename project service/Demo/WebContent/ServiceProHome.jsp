...
<li class="ttr_menu_items_parent dropdown"><a href="viewAllRequest.jsp" class="ttr_menu_items_parent_link"><span class="menuchildicon"></span>View All Pending Requests</a>
<hr class ="horiz_separator"/>
</li>
<li class="ttr_menu_items_parent dropdown"><a href="viewAllCompleteRequest.jsp" class="ttr_menu_items_parent_link"><span class="menuchildicon"></span>View All Complete Requests</a>
<hr class ="horiz_separator"/>
</li>
<li class="ttr_menu_items_parent dropdown"><a href="viewAllRejectedRequest.jsp" class="ttr_menu_items_parent_link"><span class="menuchildicon"></span>View All Rejected Requests</a>
<hr class ="horiz_separator"/>
</li>
<li class="ttr_menu_items_parent dropdown"><a href="viewAllAcceptedRequest.jsp" class="ttr_menu_items_parent_link"><span class="menuchildicon"></span>View All Accepted Requests</a>
<hr class ="horiz_separator"/>
</li>
<li class="ttr_menu_items_parent dropdown"><a href="editServiceProProfile.jsp" class="ttr_menu_items_parent_link"><span class="menuchildicon"></span>Edit Profile</a>
<hr class ="horiz_separator"/>
</li>
<li class="ttr_menu_items_parent dropdown"><a href="LogoutServicePro" class="ttr_menu_items_parent_link"><span class="menuchildicon"></span>Logout</a>
<hr class ="horiz_separator"/>
</li>
</ul>
</div>
...
<h1>Welcome to Provider HomePage</h1>
